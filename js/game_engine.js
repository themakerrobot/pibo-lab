...
const Game = {
  ...
  ITEM_INFO: {
    coin:    { label: T('동전'),   colour: 0xE8B33C },
    gem:     { label: T('보석'),   colour: 0x4FA8D8 },
    heart:   { label: T('하트'),   colour: 0xD8556A },
    box:     { label: T('상자'),   colour: 0x8C6B48 },
    star:    { label: T('별'),     colour: 0xF2D14B },
    key:     { label: T('열쇠'),   colour: 0xD9B44A },
    trash:   { label: T('휴지통'), colour: 0xC0C6CC },
    ball:    { label: T('공'),     colour: 0xF2F4F6 },
  },

...
const GAME_TOOLBOX = {
  ...
  contents: [
    { kind: 'category', name: T('시작'), colour: game_colour.event,
    ...
    { kind: 'category', name: T('움직임'), colour: game_colour.move,
    ...
    { kind: 'category', name: T('무대'), colour: game_colour.world,
    ...
    { kind: 'category', name: T('점수'), colour: game_colour.score,
      ...
      contents: [
        ...
        { kind: 'block', type: 'game_say', inputs: { MSG: gT(T('잘했어요!')) } },
        { kind: 'block', type: 'game_speak', inputs: { MSG: gT(T('안녕! 나는 파이보야')) } },
        { kind: 'block', type: 'game_over' },
      ] },

    { kind: 'category', name: T('꾸미기'), colour: game_colour.score,
    ...
    { kind: 'category', name: T('감지'), colour: game_colour.sense,
    ...
    { kind: 'category', name: T('논리'), colour: '#B098CB',
    ...
    { kind: 'category', name: T('반복'), colour: '#85B687',
    ...
    { kind: 'category', name: T('수학'), colour: '#2196F3',
    ...
    { kind: 'category', name: T('문자'), colour: '#FFAA08',
    ...
    { kind: 'category', name: T('변수'), colour: '#EF9A9A', custom: 'VARIABLE',
      cssConfig: { icon: 'customIcon fa fa-v' }, contents: [] },
    { kind: 'category', name: T('함수'), colour: '#C7BCB8', custom: 'PROCEDURE',
